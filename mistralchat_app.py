#!/usr/bin/env python3
"""Mistral Chat Desktop — abre Mistral Chat no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/mistral-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Mistral Chat Desktop v{new_ver} disponível!\n\n"
    ...
    if not browser:
        ...
        msgbox("Mistral Chat Desktop", msg)
        sys.exit(1)
